...
export default function ChatBotWidget() {
  ...
  useEffect(() => {
    ...
    <script src="./external/index.js" type="text/javascript"></script>;
    let e = document.createElement('script');
    let t = document.head || document.getElementsByTagName('head')[0];
    e.src = './external/index.js';
    e.async = true;
  ...
  return (
    <>
      <div id="script" className="script" name="script">
        <p>{loaded ? console.log('Loaded') : console.log('Not Loaded')}</p>
      </div>
    </>
  );
}
